...
# I would suggest that you put the graphs in one large figure, as it improves the readability and creates an overview

#grid.arrange(your variables here, nrow = 3, ncol = 2)
