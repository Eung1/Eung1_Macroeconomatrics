...
Deposit      <- read_rba(series_id = "DMATD")
...
- Deposit is affected from the external sector, GDP, inflation, and cash rate but not affected by other domestic variables contemporaneously. 
- credit is affected from the external sector, GDP, inflation, Cash rate, and deposit but not affected by other domestic variables contemporaneously.
