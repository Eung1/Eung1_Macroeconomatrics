...
# IRFs.k002         = apply(IRF.posterior[3:8,5,,],1:2,mean)
# IRFs.inf.k002     = apply(IRF.inf.posterior[3:8,5,],1,mean)
# rownames(IRFs.k002) = colnames(Y)[3:8]
# IRFs.k002.hdi    = apply(IRF.posterior[3:8,5,,],1:2,hdi, credMass=0.68)
# 
# 
# 
...
axis(4, (0.5*(fevd.au.credit[1:8,7]+fevd.au.credit[2:9,7]))[c(5,6,7)], c("mps","dps","crds"))
...
- Siami-Namini, S., & Hudson, D. (2016, November). US monetary policy and commodities price fluctuations. In Presentation at the 86th Annual Meeting of the Southern Economic Association. Washington DC.
